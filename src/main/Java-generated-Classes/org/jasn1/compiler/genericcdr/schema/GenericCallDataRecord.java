...
package org.jasn1.compiler.genericcdr.schema;
...
public class GenericCallDataRecord implements Serializable {
	...
	public int encode(BerByteArrayOutputStream os, boolean withTag) throws IOException {
		...
		codeLength += startTime.encode(os, false);
		// write tag: APPLICATION_CLASS, PRIMITIVE, 18
		os.write(0x52);
		codeLength += 1;
		
		codeLength += startDate.encode(os, false);
		// write tag: APPLICATION_CLASS, PRIMITIVE, 16
		os.write(0x50);
		codeLength += 1;
		
		codeLength += calledNumber.encode(os, false);
		// write tag: APPLICATION_CLASS, PRIMITIVE, 9
		os.write(0x49);
		codeLength += 1;
		
		codeLength += callingNumber.encode(os, false);
		// write tag: APPLICATION_CLASS, PRIMITIVE, 8
		os.write(0x48);
		codeLength += 1;
		
		codeLength += recordNumber.encode(os, false);
